...
import AddQuestion from "../../components/forms/questoins/add/AddQuestion";
import EditQuestion from "../../components/forms/questoins/edit/EditQuestion";
export default function Questions() {
  const { id } = useParams();
  const { t } = useTranslation();

  const { data: questions, isLoading, isSuccess } = useGetQuestionsQuery(id);
      ...
      content = (
        <>
          ...
          <DialogComponent
            ...
            size={"lg"}
          >
            <AddQuestion setShowDialog={setShowDialog} />
          </DialogComponent>
          {/* Edit Item */}
          <DialogComponent
            setShowDialog={setShowEditDialog}
            ...
            size={"lg"}
          >
            <EditQuestion setShowDialog={setShowEditDialog} />
          </DialogComponent>
          {/* Delete Item */}
          <DialogComponent
            title={t("delete")}
