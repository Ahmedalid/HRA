...
import { useCreatePackageMutation } from "../../../../redux/slices/packages/packagesSlice";
export default function AddPackage({ setShowDialog }) {
  ...
  const onSubmit = async (data) => {
    if (isLoading) return;
    createPackage(CONVERT.ConvertObjectToFormData(data))
      .unwrap()
      .then((data) => {
        if (data.status) {
          setShowDialog(false);
